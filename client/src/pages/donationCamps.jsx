                ...
                <div className="flex-1 p-4 md:p-6 bg-gray-50 overflow-y-auto">
                    <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6'>
                        <div>
                            ...
                            <p className="text-gray-500">Find and register for upcoming blood donation camps near you.</p>
                        </div>
                    ...
                    <div className="p-4 bg-white rounded-lg shadow mb-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="flex items-end">
                                <button
                                    className="w-full bg-[#E53E3E] text-white px-6 py-2 rounded text-sm flex items-center justify-center gap-2 hover:bg-red-700 transition"
                        ...
                        {loading ? (
                            ...
                            <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
                                {filteredData.map((camp) => (
                                    <div key={camp._id} className="relative p-4 bg-white rounded shadow border-l-4 border-red-500 min-h-[200px]">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-700 mb-4">
                                            <div className="flex items-start gap-2">
                                                <CalendarIcon className="w-4 h-4 text-red-500 mt-1" />
                                                <div>
